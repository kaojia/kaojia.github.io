$(() => {
    ...
    $('#cinnamon').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/01.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/02.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    ...
    $('#croissant').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/03.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/04.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#toast').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/05.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/06.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#pineapple').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/07.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/08.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#chocolatecoo').on('click', () => {
        $('#cake2>.col').empty()
        let $col = $('#cake2>.col')
        $('#cake1').modal('show')

        $img = $('<img>').attr('src', './img/cake/09.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/10.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#almond').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/11.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/12.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#angle').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/13.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/14.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#chifon').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/15.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/16.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
    $('#pound').on('click', () => {
        ...
        $img = $('<img>').attr('src', './img/cake/17.jpg').attr('class', 'cakepic')
        $img2 = $('<img>').attr('src', './img/cake/18.jpg').attr('class', 'cakepic')
        $col.append($img)
        $col.append($img2)
    })
